...
const Clients = () => {
    ...
    const fetchAllClients = async () => {
        try {
            ...
            const response = await fetch('http://api.mounassabat.ma/api/getAllClients', {
                method: 'GET',
                headers: {
        ...
        <aside className="flex flex-col w-[320px] h-screen overflow-x-hidden overflow-y-auto  -r rtl:-r-0 rtl:-l  dark:bg-black">
                            ...
                            <div className="flex flex-col justify-between flex-1 mt-6">
                                <nav>
                                    ...
                                    <Link to="/Clients" className="flex items-center px-4 py-2 mt-5 text-yellow-600 hover:text-yellow-600 transition-colors duration-300 transform rounded-lg " href="Annonces">
                                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
