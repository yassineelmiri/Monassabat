                    ...
                    <div className="py-14">
                        ...
                        <div className="w-full">
                            <h1 className="text-3xl font-serif font-bold tracking-wider text-black capitalize">
                                SIGN UP QUE PRESTATAIRE
                            </h1>
                            <div>
                                <div className=" flex justify-end mt-3 md:flex md:items-center md:-mx-2">
                                    <Link to="/ClientRegister" className="flex justify-center font-serif font-medium w-full px-6 py-3 mt-4 text-white border bg-black cursor-pointer rounded-lg md:mt-0 md:w-auto md:mx-2 hover:bg-yellow-600 hover:text-white  duration-500 focus:outline-none">
